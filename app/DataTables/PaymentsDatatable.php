...
class PaymentsDatatable extends DataTable {
	...
	public function dataTable($query) {
		return datatables($query)
			->addColumn('checkbox', 'admin.payments.btn.checkbox')
			->addColumn('edit', 'admin.payments.btn.edit')
			->addColumn('delete', 'admin.payments.btn.delete')
			->rawColumns([
				'edit',
				'delete',
				'checkbox',
	...
	public function query() {
		return Payment::query()->with('restaurant')->select('payments.*');
	}
